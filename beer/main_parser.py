...
categories = [
    ...
    'ABV',
    'IBU',
    'Calories Per Serving (12 OZ/0.35L)',
...
# Pandas config
brands = pd.read_csv('csv/brands.csv')
...
try:
    for link in brands['href']:
        ...
        for product in products:
            ...
            for ind, val in parse_beer.yield_data(product_page):
                info[ind] = val
            print(info)
    ...
    df.to_csv('csv/emergency_save.csv')
    pass

print(df.head(5))
df.to_csv('csv/beer_data.csv')
